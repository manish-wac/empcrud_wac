                ...
                <div class="form-group">
                    ...
                    <select id="cars" name="dept_id">
                        @foreach($departments as $department)
                            {
                            <option value="{{$department->id}}" <?php if($department->id==$employee->dept_id){echo 'selected';}?>>{{$department->name}}</option>
                            }
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    @foreach($designations as $designation)
                            {
                            <option value="{{$designation->id}}" <?php if($designation->id==$employee->design_id){echo 'selected';}?>>{{$designation->name}}</option>
                            }
                        @endforeach
                    </select>
                </div>
